...
public class ShowUserDetail extends AppCompatActivity {
    ...
    private void fetchUserDetails(String id) {
        ...
        dataModelCall.enqueue(new Callback<DataModel>() {
            ...
            public void onResponse(Call<DataModel> call, Response<DataModel> response) {
                ...
                {
                    Toast.makeText(ShowUserDetail.this, "Error Occured :(", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void displayUserDetails() {
        if(userObject != null)
        {
            ...
            Glide.with(ShowUserDetail.this).
    ...
    public void fetchUser(View view)
    {
        ...
        {
            Toast.makeText(ShowUserDetail.this, "Enter userId", Toast.LENGTH_SHORT).show();
            return;
        }
